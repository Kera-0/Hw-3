...
const file_flight_proto_rawDesc = "" +
	"\n" +
	"\fflight.proto\x12\x06flight\x1a\x1fgoogle/protobuf/timestamp.proto\"\xa5\x03\n" +
	"\n" +
	"FlightInfo\x12\x0e\n" +
	...
	"\x06status\x18\v \x01(\x0e2\x14.flight.FlightStatusR\x06status\"\xee\x01\n" +
	"\x13SeatReservationInfo\x12\x0e\n" +
	...
	"\n" +
	"seat_count\x18\x03 \x01(\x05R\tseatCount\"U\n" +
	"\x14ReserveSeatsResponse\x12=\n" +
	"\vreservation\x18\x01 \x01(\v2\x1b.flight.SeatReservationInfoR\vreservation\":\n" +
	"\x19ReleaseReservationRequest\x12\x1d\n" +
	"\n" +
	"booking_id\x18\x01 \x01(\tR\tbookingId\"[\n" +
	"\x1aReleaseReservationResponse\x12=\n" +
	"\vreservation\x18\x01 \x01(\v2\x1b.flight.SeatReservationInfoR\vreservation\"\xce\x02\n" +
	"\x13UpdateFlightRequest\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12(\n" +
	"\rflight_number\x18\x02 \x01(\tH\x00R\fflightNumber\x88\x01\x01\x12\x1d\n" +
	"\aairline\x18\x03 \x01(\tH\x01R\aairline\x88\x01\x01\x12\x1b\n" +
	"\x06origin\x18\x04 \x01(\tH\x02R\x06origin\x88\x01\x01\x12%\n" +
	"\vdestination\x18\x05 \x01(\tH\x03R\vdestination\x88\x01\x01\x12\x19\n" +
	"\x05price\x18\x06 \x01(\x01H\x04R\x05price\x88\x01\x01\x121\n" +
	"\x06status\x18\a \x01(\x0e2\x14.flight.FlightStatusH\x05R\x06status\x88\x01\x01B\x10\n" +
	"\x0e_flight_numberB\n" +
	"\n" +
	"\b_airlineB\t\n" +
	"\a_originB\x0e\n" +
	...
	"\x06_priceB\t\n" +
	"\a_status\"B\n" +
	"\x14UpdateFlightResponse\x12*\n" +
	"\x06flight\x18\x01 \x01(\v2\x12.flight.FlightInfoR\x06flight*\xa0\x01\n" +
	...
	"\x1aRESERVATION_STATUS_EXPIRED\x10\x032\x92\x03\n" +
	"\rFlightService\x12L\n" +
	...
	"\x12ReleaseReservation\x12!.flight.ReleaseReservationRequest\x1a\".flight.ReleaseReservationResponse\x12I\n" +
	"\fUpdateFlight\x12\x1b.flight.UpdateFlightRequest\x1a\x1c.flight.UpdateFlightResponseB\"Z flight-booking/gen/flight;flightb\x06proto3"
...
var file_flight_proto_depIdxs = []int32{
	...
	14, // 5: flight.SearchFlightsRequest.date:type_name -> google.protobuf.Timestamp
	...
	3,  // 8: flight.ReserveSeatsResponse.reservation:type_name -> flight.SeatReservationInfo
	3,  // 9: flight.ReleaseReservationResponse.reservation:type_name -> flight.SeatReservationInfo
	0,  // 10: flight.UpdateFlightRequest.status:type_name -> flight.FlightStatus
	2,  // 11: flight.UpdateFlightResponse.flight:type_name -> flight.FlightInfo
	4,  // 12: flight.FlightService.SearchFlights:input_type -> flight.SearchFlightsRequest
	6,  // 13: flight.FlightService.GetFlight:input_type -> flight.GetFlightRequest
	8,  // 14: flight.FlightService.ReserveSeats:input_type -> flight.ReserveSeatsRequest
	10, // 15: flight.FlightService.ReleaseReservation:input_type -> flight.ReleaseReservationRequest
	12, // 16: flight.FlightService.UpdateFlight:input_type -> flight.UpdateFlightRequest
	5,  // 17: flight.FlightService.SearchFlights:output_type -> flight.SearchFlightsResponse
	7,  // 18: flight.FlightService.GetFlight:output_type -> flight.GetFlightResponse
	9,  // 19: flight.FlightService.ReserveSeats:output_type -> flight.ReserveSeatsResponse
	11, // 20: flight.FlightService.ReleaseReservation:output_type -> flight.ReleaseReservationResponse
	13, // 21: flight.FlightService.UpdateFlight:output_type -> flight.UpdateFlightResponse
...
func file_flight_proto_init() {
	...
	file_flight_proto_msgTypes[10].OneofWrappers = []any{}
	type x struct{}
