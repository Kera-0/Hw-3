...
const (
	...
	FlightService_GetFlight_FullMethodName          = "/flight.FlightService/GetFlight"
	FlightService_ReserveSeats_FullMethodName       = "/flight.FlightService/ReserveSeats"
	FlightService_ReleaseReservation_FullMethodName = "/flight.FlightService/ReleaseReservation"
	FlightService_UpdateFlight_FullMethodName       = "/flight.FlightService/UpdateFlight"
)
...
func (UnimplementedFlightServiceServer) UpdateFlight(context.Context, *UpdateFlightRequest) (*UpdateFlightResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method UpdateFlight not implemented")
}
